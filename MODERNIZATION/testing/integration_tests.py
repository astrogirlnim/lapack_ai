        ...
        try:
            ...
            if total_devices > 0:
                ...
                try:
                    ...
                    result_buf = cl.Buffer(context, mem_flags.WRITE_ONLY, a.nbytes)
...
"""
            ...
            try:
                ...
                if compile_result.returncode == 0:
                    ...
                    success_text = "Fortran test completed successfully"
                    if run_result.returncode == 0 and success_text in run_result.stdout:
    ...
    def test_container_environment(self) -> Dict[str, Any]:
        ...
        results["container_detection"] = {
            ...
            "details": (
                f"Running in {'container' if is_container else 'host'} environment"
            ),
        }
        ...
        if is_container:
            ...
            self.log(
                "Not running in container - skipping container-specific tests",
                "INFO",
            )
